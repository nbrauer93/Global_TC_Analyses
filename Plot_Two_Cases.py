...
file = '2A.GPM.DPR.V8-20180723.20150925-S134857-E152130.008945.V06A.HDF5'
...
xlim = np.array([-154,-146]); ylim = np.array([11,19])
...
plt.title(r'$\bf{a)}$  Near-Surface KuPR 09/25/2015 1454 UTC', size = 26, y = 1.02)
#Add the annuli
...
label_dr = 'UR'
x_dr,y_dr = -149.6,14.7
plt.text(x_dr,y_dr,label_dr, weight = 'bold',size = 24)

label_dr = 'UL'
x_dr,y_dr = -150.5,14.5
plt.text(x_dr,y_dr,label_dr, weight = 'bold',size = 24)



label_dr = 'DR'
x_dr,y_dr = -149.75,15.8
plt.text(x_dr,y_dr,label_dr, weight = 'bold',size = 24)

label_dr = 'DL'
x_dr,y_dr = -150.85,15.6
plt.text(x_dr,y_dr,label_dr, weight = 'bold',size = 24)
